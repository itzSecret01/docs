...
1. Visite https://creepercloud.io/ e inicie sesión en su tablero.
2. Navegue a la sección **Tipos de servidor**.
3. Haga clic en **MariaDB**.

<img
  src="/imágenes/Captura de pantalla2025-05-16183957.png"
...
1. Configure su base de datos con:
   - Nombre (por ejemplo, ivfivem_dbam)
...
1. Abre tu archivo 'sserver.cfggal.
2. Agregue la siguiente línea (reemplace con sus valores reales):
...
1. Haga clic o copie el enlace ip.
2. ingrese poner el código configurar todo.
3. ¡Disfruta \! 